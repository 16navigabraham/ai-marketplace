...
const MOCK_AGENTS: Partial<Agent>[] = [
  {
    ...
    description: 'Professional writing and content creation assistance powered by AI',
    creatorAddress: '0x742d35Cc6634C0532925a3b844Bc9e7595f42aE0',
    type: 'writing',
    avatarUrl: 'https://api.placeholder.com/writing.png',
  ...
  {
    name: 'Research Agent',
    description: 'Deep research and analysis across academic and technical topics',
    creatorAddress: '0x742d35Cc6634C0532925a3b844Bc9e7595f42aE0',
    type: 'research',
    avatarUrl: 'https://api.placeholder.com/research.png',
  ...
  },
  {
    ...
    description: 'Analysis and insights for decentralized governance and DAOs',
    creatorAddress: '0x123456789abcdef0123456789abcdef012345678',
    type: 'governance',
    avatarUrl: 'https://api.placeholder.com/governance.png',
  ...
  {
    name: 'AI Butler',
    description: 'All-purpose assistant for daily tasks and information',
    creatorAddress: '0x987654321fedcba0987654321fedcba098765432',
    type: 'butler',
    avatarUrl: 'https://api.placeholder.com/butler.png',
    chains: ['polygon', 'base'],
    tokenAddresses: {},
